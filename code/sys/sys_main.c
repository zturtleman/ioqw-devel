...
void Sys_InitPIDFile(const char *gamedir) {
	...
	if (Sys_WritePIDFile(gamedir)) {
		...
		Com_sprintf(message, sizeof(message), "The last time %s ran, it didn't exit properly. This may be due to inappropriate video settings. Would you like to start with \"safe\" video settings?", CLIENT_WINDOW_TITLE);
