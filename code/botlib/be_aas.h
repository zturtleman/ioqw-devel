...
#define TFL_BARRIERJUMP			0x00000010 // jumping onto a barrier
#define TFL_SCOUTBARRIER		0x00000020 // jumping onto a barrier (the scout powerup is required)
#define TFL_JUMP				0x00000040 // jumping
#define TFL_SCOUTJUMP			0x00000080 // jumping (the scout powerup is required)
#define TFL_WALKOFFLEDGE		0x00000100 // walking of a ledge
#define TFL_SWIM				0x00000200 // swimming
#define TFL_WATERJUMP			0x00000400 // jumping out of the water
#define TFL_TELEPORT			0x00000800 // teleporting
#define TFL_ELEVATOR			0x00001000 // elevator
#define TFL_FUNCBOB				0x00002000 // func bobbing
#define TFL_JUMPPAD				0x00004000 // jump pad
#define TFL_LADDER				0x00008000 // climbing a ladder
#define TFL_BRIDGE				0x00010000 // move over a bridge
#define TFL_ROCKETJUMP			0x00020000 // rocket jumping
#define TFL_WATER				0x00040000 // travel through water
#define TFL_SLIME				0x00080000 // travel through slime
#define TFL_LAVA				0x00100000 // travel through lava
#define TFL_AIR					0x00200000 // travel through air
#define TFL_DONOTENTER			0x00400000 // travel through donotenter area
#define TFL_DONOTENTER_LARGE	0x00800000 // travel through donotenter area (for large characters)
#define TFL_NOTTEAM1			0x01000000 // not team 1
#define TFL_NOTTEAM2			0x02000000 // not team 2
// default travel flags
#define TFL_DEFAULT TFL_WALK|TFL_CROUCH|TFL_PRONE|TFL_BARRIERJUMP|TFL_SCOUTBARRIER|TFL_JUMP|TFL_SCOUTJUMP|TFL_WALKOFFLEDGE|TFL_SWIM|TFL_WATERJUMP|TFL_TELEPORT|TFL_ELEVATOR|TFL_FUNCBOB|TFL_JUMPPAD|TFL_LADDER|TFL_WATER|TFL_AIR
