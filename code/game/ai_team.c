			...
			switch (numteammates) {
				...
				default:
				{
					...
					for (i = 0; i < attackers; i++) {
						...
						BotSayTeamOrder(bs, teammates[numteammates - i - 1]);
						BotSayVoiceTeamOrder(bs, teammates[numteammates - i - 1], VOICECHAT_GETFLAG); // Tobias CHECK: change this?
					}
		...
		case 5: // CTFS_MAX_AGGRESSIVE
		{
			...
			switch (numteammates) {
				...
				case 3:
				{
					...
					BotAI_BotInitialChat(bs, "cmd_returnflag", name, NULL);
					BotSayTeamOrder(bs, teammates[2]);
					BotSayVoiceTeamOrder(bs, teammates[2], VOICECHAT_GETFLAG); // Tobias CHECK: change this?
					break;
				}
				default:
				{
